...
myDir <- "/local/zck07apu/Documents/GitLab/rammie_comparison/scripts/NoufalyFel/2x"
years=7
...
control <- list(range=in2016, alpha=0.01,
                b=4, w=3, verbose=FALSE,
                trend=TRUE, noPeriods=1,
...
for(sim in seq(nsim)){
     ...
     det1  <- farringtonFlexible(totSts1[,sim], control=control)
     det3  <- farringtonFlexible(totSts3[,sim], control=control)
     det4  <- farringtonFlexible(totSts4[,sim], control=control)
     det5  <- farringtonFlexible(totSts5[,sim], control=control)
     det6  <- farringtonFlexible(totSts6[,sim], control=control)
     det7  <- farringtonFlexible(totSts7[,sim], control=control)
     det8  <- farringtonFlexible(totSts8[,sim], control=control)
     det9  <- farringtonFlexible(totSts9[,sim], control=control)
     det10  <- farringtonFlexible(totSts10[,sim], control=control)
     det11  <- farringtonFlexible(totSts11[,sim], control=control)
     det12  <- farringtonFlexible(totSts12[,sim], control=control)
     det13  <- farringtonFlexible(totSts13[,sim], control=control)
     det14  <- farringtonFlexible(totSts14[,sim], control=control)
     det15  <- farringtonFlexible(totSts15[,sim], control=control)
     det16  <- farringtonFlexible(totSts16[,sim], control=control)
     det17  <- farringtonFlexible(totSts17[,sim], control=control)
     ...
     alarmall1[,sim] <- as.numeric(as.vector(unlist(alarms(det1))))
     alarmall3[,sim] <- as.numeric(as.vector(unlist(alarms(det3))))
     alarmall4[,sim] <- as.numeric(as.vector(unlist(alarms(det4))))
     alarmall5[,sim] <- as.numeric(as.vector(unlist(alarms(det5))))
     alarmall6[,sim] <- as.numeric(as.vector(unlist(alarms(det6))))
     alarmall7[,sim] <- as.numeric(as.vector(unlist(alarms(det7))))
     alarmall8[,sim] <- as.numeric(as.vector(unlist(alarms(det8))))
     alarmall9[,sim] <- as.numeric(as.vector(unlist(alarms(det9))))
     alarmall10[,sim] <- as.numeric(as.vector(unlist(alarms(det10))))
     alarmall11[,sim] <- as.numeric(as.vector(unlist(alarms(det11))))
     alarmall12[,sim] <- as.numeric(as.vector(unlist(alarms(det12))))
     alarmall13[,sim] <- as.numeric(as.vector(unlist(alarms(det13))))
     alarmall14[,sim] <- as.numeric(as.vector(unlist(alarms(det14))))
     alarmall15[,sim] <- as.numeric(as.vector(unlist(alarms(det15))))
     alarmall16[,sim] <- as.numeric(as.vector(unlist(alarms(det16))))
     alarmall17[,sim] <- as.numeric(as.vector(unlist(alarms(det17))))
...
fwrite(summary1, file.path(myDir, "output", "summaryNouf-18.csv"), 
          row.names=FALSE)


fwrite(summary2, file.path(myDir, "output", "summarySeasNouf-18.csv"), 
          row.names=FALSE)
