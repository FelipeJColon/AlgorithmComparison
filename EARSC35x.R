...
myDir <- "/local/zck07apu/Documents/GitLab/rammie_comparison/scripts/C3/5x"
years=7
...
fwrite(summary1, file.path(myDir, "output", "summaryC3-18.csv"), 
          row.names=FALSE)


fwrite(summary2, file.path(myDir, "output", "summarySeasC3-18.csv"), 
          row.names=FALSE)
