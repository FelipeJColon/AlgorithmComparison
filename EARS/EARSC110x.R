...
##
## DESCRIPTION
## Simulates outbreaks and analyses them using EARS-C1
##
##
...
myDir <- "/local/zck07apu/Documents/GitLab/rammie_comparison/scripts/C1/10x"
years=7
...
fwrite(summary1, file.path(myDir, "output", "summaryC1-18.csv"), 
       row.names=FALSE)


fwrite(summary2, file.path(myDir, "output", "summarySeasC1-18.csv"), 
       row.names=FALSE)
