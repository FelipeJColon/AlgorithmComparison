...
##
## DESCRIPTION
## Simulates outbreaks and analyses them using EARS-C2
##
##
...
#==========================
# Specify thebank holidays
#==========================

myDir <- "/local/zck07apu/Documents/GitLab/rammie_comparison/scripts/C2/10x"
years=7
...
fwrite(summary1, file.path(myDir, "output", "summaryC2-18.csv"), 
          row.names=FALSE)


fwrite(summary2, file.path(myDir, "output", "summarySeasC2-18.csv"), 
          row.names=FALSE)
