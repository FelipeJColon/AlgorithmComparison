...
myDir <- "/local/zck07apu/Documents/GitLab/rammie_comparison/scripts/NB/5x"
years=7
...
for(j in 1:nsim){
     ...
     for(i in (49*days):1){
          test=(alarmall1[nrow(alarmall1)-i+1,j]==1 & 
                     simulatedoutbreak1[nrow(simulatedoutbreak1)-i+1,j]>0)
          if(test==T){
